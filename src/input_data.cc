...
void input_data::initialize_data_containers()
{
  ...
  // -1 means it is the input axis.
    ...
    int    cascade_NN_corr_number_of_fields     = 2;
    string cascade_NN_corr_data_fields[]        = {"r", "f"};
    int    cascade_NN_corr_interpolate_fields[] = {-1, 1};
    double cascade_NN_corr_unit_fields[]        = {fermi, 1};
